...
defmodule PgQuery.AlterExtensionStmt do
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_extname(msg) |> encode_options(msg)
      end
    )
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(PgQuery.AlterExtensionStmt))
        end
      )
    )
  ...
  (
    ...
    def defs_by_name() do
      %{extname: {1, {:scalar, ""}, :string}, options: {2, :unpacked, {:message, PgQuery.Node}}}
    end
  )
