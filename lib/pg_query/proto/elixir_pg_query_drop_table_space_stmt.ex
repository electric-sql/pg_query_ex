...
defmodule PgQuery.DropTableSpaceStmt do
  @moduledoc false
  defstruct tablespacename: "", missing_ok: false
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_tablespacename(msg) |> encode_missing_ok(msg)
      end
    )
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(PgQuery.DropTableSpaceStmt))
        end
      )
    )
  ...
  (
    ...
    def defs_by_name() do
      %{missing_ok: {2, {:scalar, false}, :bool}, tablespacename: {1, {:scalar, ""}, :string}}
    end
  )
