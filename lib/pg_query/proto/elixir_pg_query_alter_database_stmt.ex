...
defmodule PgQuery.AlterDatabaseStmt do
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_dbname(msg) |> encode_options(msg)
      end
    )
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(PgQuery.AlterDatabaseStmt))
        end
      )
    )
  ...
  (
    ...
    def defs_by_name() do
      %{dbname: {1, {:scalar, ""}, :string}, options: {2, :unpacked, {:message, PgQuery.Node}}}
    end
  )
