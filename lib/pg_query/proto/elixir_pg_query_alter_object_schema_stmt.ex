...
defmodule PgQuery.AlterObjectSchemaStmt do
  ...
  (
    ...
    [
      ...
      defp encode_newschema(acc, msg) do
        try do
          if msg.newschema == "" do
            acc
          else
            [acc, "\"", Protox.Encode.encode_string(msg.newschema)]
          end
        rescue
          ArgumentError ->
  ...
  (
    ...
    def defs() do
      %{
        ...
        4 => {:newschema, {:scalar, ""}, :string},
        5 => {:missing_ok, {:scalar, false}, :bool}
      }
    end
    ...
    def defs_by_name() do
      %{
        missing_ok: {5, {:scalar, false}, :bool},
        newschema: {4, {:scalar, ""}, :string},
