...
defmodule PgQuery.AlterDefaultPrivilegesStmt do
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_options(msg) |> encode_action(msg)
      end
    )
      ...
      defp encode_action(acc, msg) do
        try do
          if msg.action == nil do
            ...
            [acc, "\x12", Protox.Encode.encode_message(msg.action)]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(PgQuery.AlterDefaultPrivilegesStmt))
        end
      )
    )
        ...
        {field, rest} =
          case Protox.Decode.parse_key(bytes) do
            ...
            {2, _, bytes} ->
              ...
              {[
                 action:
                   Protox.MergeMessage.merge(msg.action, PgQuery.GrantStmt.decode!(delimited))
               ], rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        PgQuery.AlterDefaultPrivilegesStmt,
  ...
  (
    ...
    def defs() do
      %{
        ...
        2 => {:action, {:scalar, nil}, {:message, PgQuery.GrantStmt}}
      }
    end
    ...
    def defs_by_name() do
      %{
        action: {2, {:scalar, nil}, {:message, PgQuery.GrantStmt}},
