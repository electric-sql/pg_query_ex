...
defmodule PgQuery.NamedArgExpr do
  @moduledoc false
  defstruct xpr: nil, arg: nil, name: "", argnumber: 0, location: 0
  ...
  (
    ...
    [
      ...
      defp encode_argnumber(acc, msg) do
        try do
          if msg.argnumber == 0 do
            acc
          else
            [acc, " ", Protox.Encode.encode_int32(msg.argnumber)]
          end
        rescue
          ArgumentError ->
