...
defmodule PgQuery.PartitionElem do
  @moduledoc false
  defstruct name: "", expr: nil, collation: [], opclass: [], location: 0
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(PgQuery.PartitionElem))
        end
      )
    )
  ...
  (
    ...
    def defs() do
      %{
        ...
        3 => {:collation, :unpacked, {:message, PgQuery.Node}},
        4 => {:opclass, :unpacked, {:message, PgQuery.Node}},
