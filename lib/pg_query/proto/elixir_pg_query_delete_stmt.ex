  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(PgQuery.DeleteStmt))
        end
      )
    )
  ...
  (
    ...
    def defs() do
      %{
        ...
        2 => {:using_clause, :unpacked, {:message, PgQuery.Node}},
        3 => {:where_clause, {:scalar, nil}, {:message, PgQuery.Node}},
        4 => {:returning_list, :unpacked, {:message, PgQuery.Node}},
    ...
    def defs_by_name() do
      %{
        ...
        returning_list: {4, :unpacked, {:message, PgQuery.Node}},
        using_clause: {2, :unpacked, {:message, PgQuery.Node}},
