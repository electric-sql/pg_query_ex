...
defmodule PgQuery.CreateRangeStmt do
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_type_name(msg) |> encode_params(msg)
      end
    )
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(PgQuery.CreateRangeStmt))
        end
      )
    )
  ...
  (
    ...
    def defs() do
      %{
        ...
        2 => {:params, :unpacked, {:message, PgQuery.Node}}
      }
    end
    ...
    def defs_by_name() do
      %{
        params: {2, :unpacked, {:message, PgQuery.Node}},
