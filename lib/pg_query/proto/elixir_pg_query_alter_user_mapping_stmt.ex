...
defmodule PgQuery.AlterUserMappingStmt do
  @moduledoc false
  defstruct user: nil, servername: "", options: []
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_user(msg) |> encode_servername(msg) |> encode_options(msg)
      end
    )
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(PgQuery.AlterUserMappingStmt))
        end
      )
    )
