...
defmodule PgQuery.AlterRoleStmt do
  @moduledoc false
  defstruct role: nil, options: [], action: 0
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_role(msg) |> encode_options(msg) |> encode_action(msg)
      end
    )
      ...
      defp encode_action(acc, msg) do
        try do
          if msg.action == 0 do
            ...
            [acc, "\x18", Protox.Encode.encode_int32(msg.action)]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(PgQuery.AlterRoleStmt))
        end
      )
    )
