...
defmodule PgQuery.CreateSeqStmt do
  @moduledoc false
  defstruct sequence: nil, options: [], owner_id: 0, for_identity: false, if_not_exists: false
      ...
      defp encode_for_identity(acc, msg) do
        try do
          if msg.for_identity == false do
            ...
            [acc, " ", Protox.Encode.encode_bool(msg.for_identity)]
          end
        rescue
          ArgumentError ->
  ...
  (
    ...
    def defs() do
      %{
        ...
        4 => {:for_identity, {:scalar, false}, :bool},
    ...
    def defs_by_name() do
      %{
        for_identity: {4, {:scalar, false}, :bool},
