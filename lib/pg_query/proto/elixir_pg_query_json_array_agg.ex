...
defmodule PgQuery.JsonArrayAgg do
  @moduledoc false
  defstruct constructor: nil, arg: nil, absent_on_null: false
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_constructor(msg) |> encode_arg(msg) |> encode_absent_on_null(msg)
      end
    )
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(PgQuery.JsonArrayAgg))
        end
      )
    )
        ...
        {field, rest} =
          case Protox.Decode.parse_key(bytes) do
            ...
            {2, _, bytes} ->
              ...
              {[
                 arg: Protox.MergeMessage.merge(msg.arg, PgQuery.JsonValueExpr.decode!(delimited))
               ], rest}
  ...
  (
    ...
    def defs() do
      %{
        ...
        2 => {:arg, {:scalar, nil}, {:message, PgQuery.JsonValueExpr}},
    ...
    def defs_by_name() do
      %{
        ...
        arg: {2, {:scalar, nil}, {:message, PgQuery.JsonValueExpr}},
