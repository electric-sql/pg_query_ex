...
defmodule PgQuery.CreateForeignServerStmt do
  ...
  (
    ...
    [
      ...
      defp encode_servertype(acc, msg) do
        try do
          if msg.servertype == "" do
            acc
          else
            [acc, "\x12", Protox.Encode.encode_string(msg.servertype)]
          end
        rescue
          ArgumentError ->
            reraise Protox.EncodingError.new(:servertype, "invalid field value"), __STACKTRACE__
        end
      end,
      defp encode_version(acc, msg) do
        try do
          if msg.version == "" do
            ...
            [acc, "\x1A", Protox.Encode.encode_string(msg.version)]
          end
        rescue
          ArgumentError ->
      ...
      defp encode_fdwname(acc, msg) do
        try do
          if msg.fdwname == "" do
            acc
          else
            [acc, "\"", Protox.Encode.encode_string(msg.fdwname)]
          end
        rescue
          ArgumentError ->
            reraise Protox.EncodingError.new(:fdwname, "invalid field value"), __STACKTRACE__
        end
      end,
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(PgQuery.CreateForeignServerStmt))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        PgQuery.CreateForeignServerStmt,
  ...
  (
    ...
    def defs() do
      %{
        ...
        2 => {:servertype, {:scalar, ""}, :string},
        3 => {:version, {:scalar, ""}, :string},
        4 => {:fdwname, {:scalar, ""}, :string},
  ...
  [
    ...
    def default(:servertype) do
      {:ok, ""}
    end,
    def default(:version) do
      {:ok, ""}
    end,
    def default(:fdwname) do
      {:ok, ""}
    end,
