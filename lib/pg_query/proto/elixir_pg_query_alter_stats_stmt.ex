...
defmodule PgQuery.AlterStatsStmt do
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_defnames(msg) |> encode_stxstattarget(msg) |> encode_missing_ok(msg)
      end
    )
    ...
    [
      ...
      defp encode_stxstattarget(acc, msg) do
        try do
          ...
          ArgumentError ->
            reraise Protox.EncodingError.new(:stxstattarget, "invalid field value"),
                    __STACKTRACE__
        end
      end,
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(PgQuery.AlterStatsStmt))
        end
      )
    )
  ...
  (
    ...
    [
      ...
      (
        def field_def(:stxstattarget) do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "stxstattarget",
