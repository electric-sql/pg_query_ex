...
defmodule PgQuery.CreateExtensionStmt do
  @moduledoc false
  defstruct extname: "", if_not_exists: false, options: []
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_extname(msg) |> encode_if_not_exists(msg) |> encode_options(msg)
      end
    )
      ...
      defp encode_extname(acc, msg) do
        try do
          if msg.extname == "" do
            ...
            [acc, "\n", Protox.Encode.encode_string(msg.extname)]
          end
        rescue
          ArgumentError ->
      ...
      defp encode_if_not_exists(acc, msg) do
        try do
          if msg.if_not_exists == false do
            ...
            [acc, "\x10", Protox.Encode.encode_bool(msg.if_not_exists)]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(PgQuery.CreateExtensionStmt))
        end
      )
    )
  ...
  (
    ...
    def defs() do
      %{
        1 => {:extname, {:scalar, ""}, :string},
        2 => {:if_not_exists, {:scalar, false}, :bool},
    ...
    def defs_by_name() do
      %{
        extname: {1, {:scalar, ""}, :string},
        if_not_exists: {2, {:scalar, false}, :bool},
