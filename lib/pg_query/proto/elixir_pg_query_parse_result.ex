...
defmodule PgQuery.ParseResult do
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_version(msg) |> encode_stmts(msg)
      end
    )
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(PgQuery.ParseResult))
        end
      )
    )
        ...
        {field, rest} =
          case Protox.Decode.parse_key(bytes) do
            ...
            {2, _, bytes} ->
              ...
              {[stmts: msg.stmts ++ [PgQuery.RawStmt.decode!(delimited)]], rest}
  ...
  (
    ...
    def defs() do
      %{
        ...
        2 => {:stmts, :unpacked, {:message, PgQuery.RawStmt}}
      }
    end
    ...
    def defs_by_name() do
      %{stmts: {2, :unpacked, {:message, PgQuery.RawStmt}}, version: {1, {:scalar, 0}, :int32}}
    end
  )
