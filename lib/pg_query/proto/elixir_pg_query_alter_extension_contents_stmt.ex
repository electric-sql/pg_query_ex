...
defmodule PgQuery.AlterExtensionContentsStmt do
  @moduledoc false
  defstruct extname: "", action: 0, objtype: :OBJECT_TYPE_UNDEFINED, object: nil
      ...
      defp encode_action(acc, msg) do
        try do
          if msg.action == 0 do
            ...
            [acc, "\x10", Protox.Encode.encode_int32(msg.action)]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(PgQuery.AlterExtensionContentsStmt))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        PgQuery.AlterExtensionContentsStmt,
