...
defmodule PgQuery.PLAssignStmt do
  @moduledoc false
  defstruct name: "", indirection: [], nnames: 0, val: nil, location: 0
  ...
  (
    ...
    [
      ...
      defp encode_nnames(acc, msg) do
        try do
          if msg.nnames == 0 do
            acc
          else
            [acc, "\x18", Protox.Encode.encode_int32(msg.nnames)]
          end
        rescue
          ArgumentError ->
      ...
      defp encode_val(acc, msg) do
        try do
          if msg.val == nil do
            ...
            [acc, "\"", Protox.Encode.encode_message(msg.val)]
          end
        rescue
          ArgumentError ->
  ...
  (
    ...
    def defs() do
      %{
        ...
        3 => {:nnames, {:scalar, 0}, :int32},
        4 => {:val, {:scalar, nil}, {:message, PgQuery.SelectStmt}},
    ...
    def defs_by_name() do
      %{
        ...
        nnames: {3, {:scalar, 0}, :int32},
        val: {4, {:scalar, nil}, {:message, PgQuery.SelectStmt}}
      }
    end
  )
