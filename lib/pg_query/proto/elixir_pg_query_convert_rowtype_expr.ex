...
defmodule PgQuery.ConvertRowtypeExpr do
  ...
  defstruct xpr: nil,
            arg: nil,
            resulttype: 0,
            convertformat: :COERCION_FORM_UNDEFINED,
            location: 0
  ...
  (
    ...
    [
      ...
      defp encode_convertformat(acc, msg) do
        try do
          if msg.convertformat == :COERCION_FORM_UNDEFINED do
            acc
          else
            [
              acc,
              " ",
              msg.convertformat |> PgQuery.CoercionForm.encode() |> Protox.Encode.encode_enum()
            ]
          end
        rescue
          ArgumentError ->
            reraise Protox.EncodingError.new(:convertformat, "invalid field value"),
                    __STACKTRACE__
        end
      end,
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(PgQuery.ConvertRowtypeExpr))
        end
      )
    )
  ...
  (
    ...
    def defs() do
      %{
        ...
        4 => {:convertformat, {:scalar, :COERCION_FORM_UNDEFINED}, {:enum, PgQuery.CoercionForm}},
    ...
    def defs_by_name() do
      %{
        ...
        convertformat: {4, {:scalar, :COERCION_FORM_UNDEFINED}, {:enum, PgQuery.CoercionForm}},
  ...
  (
    ...
    [
      ...
      (
        def field_def(:convertformat) do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "convertformat",
