      ...
      defp encode_atomic(acc, msg) do
        try do
          if msg.atomic == false do
            ...
            [acc, "\b", Protox.Encode.encode_bool(msg.atomic)]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(PgQuery.CallContext))
        end
      )
    )
