  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(PgQuery.CoerceViaIO))
        end
      )
    )
  ...
  (
    ...
    def defs() do
      %{
        ...
        4 => {:resultcollid, {:scalar, 0}, :uint32},
        5 => {:coerceformat, {:scalar, :COERCION_FORM_UNDEFINED}, {:enum, PgQuery.CoercionForm}},
    ...
    def defs_by_name() do
      %{
        ...
        coerceformat: {5, {:scalar, :COERCION_FORM_UNDEFINED}, {:enum, PgQuery.CoercionForm}},
        location: {6, {:scalar, 0}, :int32},
        resultcollid: {4, {:scalar, 0}, :uint32},
