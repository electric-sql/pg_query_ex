...
defmodule PgQuery.JsonSerializeExpr do
  @moduledoc false
  defstruct expr: nil, output: nil, location: 0
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_expr(msg) |> encode_output(msg) |> encode_location(msg)
      end
    )
