...
defmodule PgQuery.AlterFunctionStmt do
  @moduledoc false
  defstruct objtype: :OBJECT_TYPE_UNDEFINED, func: nil, actions: []
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_objtype(msg) |> encode_func(msg) |> encode_actions(msg)
      end
    )
      ...
      defp encode_func(acc, msg) do
        try do
          if msg.func == nil do
            ...
            [acc, "\x12", Protox.Encode.encode_message(msg.func)]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(PgQuery.AlterFunctionStmt))
        end
      )
    )
  ...
  (
    ...
    def defs() do
      %{
        ...
        2 => {:func, {:scalar, nil}, {:message, PgQuery.ObjectWithArgs}},
        3 => {:actions, :unpacked, {:message, PgQuery.Node}}
      }
    end
    ...
    def defs_by_name() do
      %{
        actions: {3, :unpacked, {:message, PgQuery.Node}},
        func: {2, {:scalar, nil}, {:message, PgQuery.ObjectWithArgs}},
