...
defmodule PgQuery.LockStmt do
  @moduledoc false
  defstruct relations: [], mode: 0, nowait: false
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_relations(msg) |> encode_mode(msg) |> encode_nowait(msg)
      end
    )
      ...
      defp encode_mode(acc, msg) do
        try do
          if msg.mode == 0 do
            ...
            [acc, "\x10", Protox.Encode.encode_int32(msg.mode)]
          end
        rescue
          ArgumentError ->
      ...
      defp encode_nowait(acc, msg) do
        try do
          if msg.nowait == false do
            ...
            [acc, "\x18", Protox.Encode.encode_bool(msg.nowait)]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(PgQuery.LockStmt))
        end
      )
    )
  ...
  (
    ...
    def defs() do
      %{
        ...
        2 => {:mode, {:scalar, 0}, :int32},
        3 => {:nowait, {:scalar, false}, :bool}
      }
    end
    ...
    def defs_by_name() do
      %{
        mode: {2, {:scalar, 0}, :int32},
        nowait: {3, {:scalar, false}, :bool},
