...
defmodule PgQuery.CollateExpr do
  @moduledoc false
  defstruct xpr: nil, arg: nil, coll_oid: 0, location: 0
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_xpr(msg) |> encode_arg(msg) |> encode_coll_oid(msg) |> encode_location(msg)
      end
    )
      ...
      defp encode_coll_oid(acc, msg) do
        try do
          if msg.coll_oid == 0 do
            ...
            [acc, "\x18", Protox.Encode.encode_uint32(msg.coll_oid)]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(PgQuery.CollateExpr))
        end
      )
    )
