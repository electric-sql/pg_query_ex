...
defmodule PgQuery.Node do
  ...
  (
    ...
    [
      defp encode_node(acc, msg) do
        case msg.node do
          ...
          {:window_func_run_condition, _field_value} ->
            encode_window_func_run_condition(acc, msg)

          {:merge_support_func, _field_value} ->
            encode_merge_support_func(acc, msg)
          ...
          {:json_format, _field_value} ->
            encode_json_format(acc, msg)

          {:json_returning, _field_value} ->
            encode_json_returning(acc, msg)

          {:json_value_expr, _field_value} ->
            encode_json_value_expr(acc, msg)

          {:json_constructor_expr, _field_value} ->
            encode_json_constructor_expr(acc, msg)

          {:json_is_predicate, _field_value} ->
            encode_json_is_predicate(acc, msg)

          {:json_behavior, _field_value} ->
            encode_json_behavior(acc, msg)

          {:json_expr, _field_value} ->
            encode_json_expr(acc, msg)

          {:json_table_path, _field_value} ->
            encode_json_table_path(acc, msg)

          {:json_table_path_scan, _field_value} ->
            encode_json_table_path_scan(acc, msg)

          {:json_table_sibling_join, _field_value} ->
            encode_json_table_sibling_join(acc, msg)
          ...
          {:single_partition_spec, _field_value} ->
            encode_single_partition_spec(acc, msg)
          ...
          {:rtepermission_info, _field_value} ->
            encode_rtepermission_info(acc, msg)
          ...
          {:json_output, _field_value} ->
            encode_json_output(acc, msg)

          {:json_argument, _field_value} ->
            encode_json_argument(acc, msg)

          {:json_func_expr, _field_value} ->
            encode_json_func_expr(acc, msg)

          {:json_table_path_spec, _field_value} ->
            encode_json_table_path_spec(acc, msg)

          {:json_table, _field_value} ->
            encode_json_table(acc, msg)

          {:json_table_column, _field_value} ->
            encode_json_table_column(acc, msg)

          {:json_key_value, _field_value} ->
            encode_json_key_value(acc, msg)

          {:json_parse_expr, _field_value} ->
            encode_json_parse_expr(acc, msg)

          {:json_scalar_expr, _field_value} ->
            encode_json_scalar_expr(acc, msg)

          {:json_serialize_expr, _field_value} ->
            encode_json_serialize_expr(acc, msg)

          {:json_object_constructor, _field_value} ->
            encode_json_object_constructor(acc, msg)

          {:json_array_constructor, _field_value} ->
            encode_json_array_constructor(acc, msg)

          {:json_array_query_constructor, _field_value} ->
            encode_json_array_query_constructor(acc, msg)

          {:json_agg_constructor, _field_value} ->
            encode_json_agg_constructor(acc, msg)

          {:json_object_agg, _field_value} ->
            encode_json_object_agg(acc, msg)

          {:json_array_agg, _field_value} ->
            encode_json_array_agg(acc, msg)
    ...
    [
      ...
      defp encode_window_func_run_condition(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "R", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
            reraise Protox.EncodingError.new(:window_func_run_condition, "invalid field value"),
                    __STACKTRACE__
        end
      end,
      defp encode_merge_support_func(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "Z", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
            reraise Protox.EncodingError.new(:merge_support_func, "invalid field value"),
                    __STACKTRACE__
        end
      end,
      ...
      defp encode_json_format(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\xC2\x02", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
            reraise Protox.EncodingError.new(:json_format, "invalid field value"), __STACKTRACE__
        end
      end,
      defp encode_json_returning(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\xCA\x02", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
            reraise Protox.EncodingError.new(:json_returning, "invalid field value"),
                    __STACKTRACE__
        end
      end,
      defp encode_json_value_expr(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\xD2\x02", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
            reraise Protox.EncodingError.new(:json_value_expr, "invalid field value"),
                    __STACKTRACE__
        end
      end,
      defp encode_json_constructor_expr(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\xDA\x02", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
            reraise Protox.EncodingError.new(:json_constructor_expr, "invalid field value"),
                    __STACKTRACE__
        end
      end,
      defp encode_json_is_predicate(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\xE2\x02", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
            reraise Protox.EncodingError.new(:json_is_predicate, "invalid field value"),
                    __STACKTRACE__
        end
      end,
      defp encode_json_behavior(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\xEA\x02", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
            reraise Protox.EncodingError.new(:json_behavior, "invalid field value"),
                    __STACKTRACE__
        end
      end,
      defp encode_json_expr(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\xF2\x02", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
            reraise Protox.EncodingError.new(:json_expr, "invalid field value"), __STACKTRACE__
        end
      end,
      defp encode_json_table_path(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\xFA\x02", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
            reraise Protox.EncodingError.new(:json_table_path, "invalid field value"),
                    __STACKTRACE__
        end
      end,
      defp encode_json_table_path_scan(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\x82\x03", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
            reraise Protox.EncodingError.new(:json_table_path_scan, "invalid field value"),
                    __STACKTRACE__
        end
      end,
      defp encode_json_table_sibling_join(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\x8A\x03", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
            reraise Protox.EncodingError.new(:json_table_sibling_join, "invalid field value"),
                    __STACKTRACE__
        end
      end,
      ...
      defp encode_single_partition_spec(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\x82\x06", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
            reraise Protox.EncodingError.new(:single_partition_spec, "invalid field value"),
                    __STACKTRACE__
        end
      end,
      ...
      defp encode_rtepermission_info(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\x9A\x06", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
            reraise Protox.EncodingError.new(:rtepermission_info, "invalid field value"),
                    __STACKTRACE__
        end
      end,
      ...
      defp encode_json_output(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\x9A\a", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
            reraise Protox.EncodingError.new(:json_output, "invalid field value"), __STACKTRACE__
        end
      end,
      defp encode_json_argument(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\xA2\a", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
            reraise Protox.EncodingError.new(:json_argument, "invalid field value"),
                    __STACKTRACE__
        end
      end,
      defp encode_json_func_expr(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\xAA\a", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
            reraise Protox.EncodingError.new(:json_func_expr, "invalid field value"),
                    __STACKTRACE__
        end
      end,
      defp encode_json_table_path_spec(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\xB2\a", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
            reraise Protox.EncodingError.new(:json_table_path_spec, "invalid field value"),
                    __STACKTRACE__
        end
      end,
      defp encode_json_table(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\xBA\a", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
            reraise Protox.EncodingError.new(:json_table, "invalid field value"), __STACKTRACE__
        end
      end,
      defp encode_json_table_column(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\xC2\a", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
            reraise Protox.EncodingError.new(:json_table_column, "invalid field value"),
                    __STACKTRACE__
        end
      end,
      defp encode_json_key_value(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\xCA\a", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
            reraise Protox.EncodingError.new(:json_key_value, "invalid field value"),
                    __STACKTRACE__
        end
      end,
      defp encode_json_parse_expr(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\xD2\a", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
            reraise Protox.EncodingError.new(:json_parse_expr, "invalid field value"),
                    __STACKTRACE__
        end
      end,
      defp encode_json_scalar_expr(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\xDA\a", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
            reraise Protox.EncodingError.new(:json_scalar_expr, "invalid field value"),
                    __STACKTRACE__
        end
      end,
      defp encode_json_serialize_expr(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\xE2\a", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
            reraise Protox.EncodingError.new(:json_serialize_expr, "invalid field value"),
                    __STACKTRACE__
        end
      end,
      defp encode_json_object_constructor(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\xEA\a", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
            reraise Protox.EncodingError.new(:json_object_constructor, "invalid field value"),
                    __STACKTRACE__
        end
      end,
      defp encode_json_array_constructor(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\xF2\a", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
            reraise Protox.EncodingError.new(:json_array_constructor, "invalid field value"),
                    __STACKTRACE__
        end
      end,
      defp encode_json_array_query_constructor(acc, msg) do
        try do
          {_, child_field_value} = msg.node
      ...
      defp encode_json_agg_constructor(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\x82\b", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
            reraise Protox.EncodingError.new(:json_agg_constructor, "invalid field value"),
                    __STACKTRACE__
        end
      end,
      defp encode_json_object_agg(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\x8A\b", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
            reraise Protox.EncodingError.new(:json_object_agg, "invalid field value"),
                    __STACKTRACE__
        end
      end,
      defp encode_json_array_agg(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\x92\b", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
            reraise Protox.EncodingError.new(:json_array_agg, "invalid field value"),
                    __STACKTRACE__
        end
      end,
      ...
      defp encode_discard_stmt(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\xFA\x0E", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
      ...
      defp encode_lock_stmt(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\x82\x0F", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
      ...
      defp encode_constraints_set_stmt(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\x8A\x0F", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
      ...
      defp encode_reindex_stmt(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\x92\x0F", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
      ...
      defp encode_create_conversion_stmt(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\x9A\x0F", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
      ...
      defp encode_create_cast_stmt(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\xA2\x0F", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
      ...
      defp encode_create_transform_stmt(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\xAA\x0F", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
      ...
      defp encode_prepare_stmt(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\xB2\x0F", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
      ...
      defp encode_execute_stmt(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\xBA\x0F", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
      ...
      defp encode_deallocate_stmt(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\xC2\x0F", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
      ...
      defp encode_drop_owned_stmt(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\xCA\x0F", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
      ...
      defp encode_reassign_owned_stmt(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\xD2\x0F", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
      ...
      defp encode_alter_tsdictionary_stmt(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\xDA\x0F", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
      ...
      defp encode_alter_tsconfiguration_stmt(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\xE2\x0F", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
      ...
      defp encode_publication_table(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\xEA\x0F", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
      ...
      defp encode_publication_obj_spec(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\xF2\x0F", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
      ...
      defp encode_create_publication_stmt(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\xFA\x0F", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
      ...
      defp encode_alter_publication_stmt(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\x82\x10", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
      ...
      defp encode_create_subscription_stmt(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\x8A\x10", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
      ...
      defp encode_alter_subscription_stmt(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\x92\x10", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
      ...
      defp encode_drop_subscription_stmt(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\x9A\x10", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
      ...
      defp encode_integer(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\xA2\x10", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
      ...
      defp encode_float(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\xAA\x10", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
      ...
      defp encode_boolean(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\xB2\x10", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
      ...
      defp encode_string(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\xBA\x10", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
      ...
      defp encode_bit_string(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\xC2\x10", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
      ...
      defp encode_list(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\xCA\x10", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
      ...
      defp encode_int_list(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\xD2\x10", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
      ...
      defp encode_oid_list(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\xDA\x10", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
      ...
      defp encode_a_const(acc, msg) do
        try do
          {_, child_field_value} = msg.node
          [acc, "\xE2\x10", Protox.Encode.encode_message(child_field_value)]
        rescue
          ArgumentError ->
  ...
  (
    ...
    def defs() do
      %{
        ...
        4 => {:into_clause, {:oneof, :node}, {:message, PgQuery.IntoClause}},
        5 => {:var, {:oneof, :node}, {:message, PgQuery.Var}},
        6 => {:param, {:oneof, :node}, {:message, PgQuery.Param}},
        7 => {:aggref, {:oneof, :node}, {:message, PgQuery.Aggref}},
        8 => {:grouping_func, {:oneof, :node}, {:message, PgQuery.GroupingFunc}},
        9 => {:window_func, {:oneof, :node}, {:message, PgQuery.WindowFunc}},
        10 =>
          {:window_func_run_condition, {:oneof, :node},
           {:message, PgQuery.WindowFuncRunCondition}},
        11 => {:merge_support_func, {:oneof, :node}, {:message, PgQuery.MergeSupportFunc}},
        12 => {:subscripting_ref, {:oneof, :node}, {:message, PgQuery.SubscriptingRef}},
        13 => {:func_expr, {:oneof, :node}, {:message, PgQuery.FuncExpr}},
        14 => {:named_arg_expr, {:oneof, :node}, {:message, PgQuery.NamedArgExpr}},
        15 => {:op_expr, {:oneof, :node}, {:message, PgQuery.OpExpr}},
        16 => {:distinct_expr, {:oneof, :node}, {:message, PgQuery.DistinctExpr}},
        17 => {:null_if_expr, {:oneof, :node}, {:message, PgQuery.NullIfExpr}},
        18 => {:scalar_array_op_expr, {:oneof, :node}, {:message, PgQuery.ScalarArrayOpExpr}},
        19 => {:bool_expr, {:oneof, :node}, {:message, PgQuery.BoolExpr}},
        20 => {:sub_link, {:oneof, :node}, {:message, PgQuery.SubLink}},
        21 => {:sub_plan, {:oneof, :node}, {:message, PgQuery.SubPlan}},
        22 => {:alternative_sub_plan, {:oneof, :node}, {:message, PgQuery.AlternativeSubPlan}},
        23 => {:field_select, {:oneof, :node}, {:message, PgQuery.FieldSelect}},
        24 => {:field_store, {:oneof, :node}, {:message, PgQuery.FieldStore}},
        25 => {:relabel_type, {:oneof, :node}, {:message, PgQuery.RelabelType}},
        26 => {:coerce_via_io, {:oneof, :node}, {:message, PgQuery.CoerceViaIO}},
        27 => {:array_coerce_expr, {:oneof, :node}, {:message, PgQuery.ArrayCoerceExpr}},
        28 => {:convert_rowtype_expr, {:oneof, :node}, {:message, PgQuery.ConvertRowtypeExpr}},
        29 => {:collate_expr, {:oneof, :node}, {:message, PgQuery.CollateExpr}},
        30 => {:case_expr, {:oneof, :node}, {:message, PgQuery.CaseExpr}},
        31 => {:case_when, {:oneof, :node}, {:message, PgQuery.CaseWhen}},
        32 => {:case_test_expr, {:oneof, :node}, {:message, PgQuery.CaseTestExpr}},
        33 => {:array_expr, {:oneof, :node}, {:message, PgQuery.ArrayExpr}},
        34 => {:row_expr, {:oneof, :node}, {:message, PgQuery.RowExpr}},
        35 => {:row_compare_expr, {:oneof, :node}, {:message, PgQuery.RowCompareExpr}},
        36 => {:coalesce_expr, {:oneof, :node}, {:message, PgQuery.CoalesceExpr}},
        37 => {:min_max_expr, {:oneof, :node}, {:message, PgQuery.MinMaxExpr}},
        38 => {:sqlvalue_function, {:oneof, :node}, {:message, PgQuery.SQLValueFunction}},
        39 => {:xml_expr, {:oneof, :node}, {:message, PgQuery.XmlExpr}},
        40 => {:json_format, {:oneof, :node}, {:message, PgQuery.JsonFormat}},
        41 => {:json_returning, {:oneof, :node}, {:message, PgQuery.JsonReturning}},
        42 => {:json_value_expr, {:oneof, :node}, {:message, PgQuery.JsonValueExpr}},
        43 => {:json_constructor_expr, {:oneof, :node}, {:message, PgQuery.JsonConstructorExpr}},
        44 => {:json_is_predicate, {:oneof, :node}, {:message, PgQuery.JsonIsPredicate}},
        45 => {:json_behavior, {:oneof, :node}, {:message, PgQuery.JsonBehavior}},
        46 => {:json_expr, {:oneof, :node}, {:message, PgQuery.JsonExpr}},
        47 => {:json_table_path, {:oneof, :node}, {:message, PgQuery.JsonTablePath}},
        48 => {:json_table_path_scan, {:oneof, :node}, {:message, PgQuery.JsonTablePathScan}},
        49 =>
          {:json_table_sibling_join, {:oneof, :node}, {:message, PgQuery.JsonTableSiblingJoin}},
        50 => {:null_test, {:oneof, :node}, {:message, PgQuery.NullTest}},
        51 => {:boolean_test, {:oneof, :node}, {:message, PgQuery.BooleanTest}},
        52 => {:merge_action, {:oneof, :node}, {:message, PgQuery.MergeAction}},
        53 => {:coerce_to_domain, {:oneof, :node}, {:message, PgQuery.CoerceToDomain}},
        54 => {:coerce_to_domain_value, {:oneof, :node}, {:message, PgQuery.CoerceToDomainValue}},
        55 => {:set_to_default, {:oneof, :node}, {:message, PgQuery.SetToDefault}},
        56 => {:current_of_expr, {:oneof, :node}, {:message, PgQuery.CurrentOfExpr}},
        57 => {:next_value_expr, {:oneof, :node}, {:message, PgQuery.NextValueExpr}},
        58 => {:inference_elem, {:oneof, :node}, {:message, PgQuery.InferenceElem}},
        59 => {:target_entry, {:oneof, :node}, {:message, PgQuery.TargetEntry}},
        60 => {:range_tbl_ref, {:oneof, :node}, {:message, PgQuery.RangeTblRef}},
        61 => {:join_expr, {:oneof, :node}, {:message, PgQuery.JoinExpr}},
        62 => {:from_expr, {:oneof, :node}, {:message, PgQuery.FromExpr}},
        63 => {:on_conflict_expr, {:oneof, :node}, {:message, PgQuery.OnConflictExpr}},
        64 => {:query, {:oneof, :node}, {:message, PgQuery.Query}},
        65 => {:type_name, {:oneof, :node}, {:message, PgQuery.TypeName}},
        66 => {:column_ref, {:oneof, :node}, {:message, PgQuery.ColumnRef}},
        67 => {:param_ref, {:oneof, :node}, {:message, PgQuery.ParamRef}},
        68 => {:a_expr, {:oneof, :node}, {:message, PgQuery.A_Expr}},
        69 => {:type_cast, {:oneof, :node}, {:message, PgQuery.TypeCast}},
        70 => {:collate_clause, {:oneof, :node}, {:message, PgQuery.CollateClause}},
        71 => {:role_spec, {:oneof, :node}, {:message, PgQuery.RoleSpec}},
        72 => {:func_call, {:oneof, :node}, {:message, PgQuery.FuncCall}},
        73 => {:a_star, {:oneof, :node}, {:message, PgQuery.A_Star}},
        74 => {:a_indices, {:oneof, :node}, {:message, PgQuery.A_Indices}},
        75 => {:a_indirection, {:oneof, :node}, {:message, PgQuery.A_Indirection}},
        76 => {:a_array_expr, {:oneof, :node}, {:message, PgQuery.A_ArrayExpr}},
        77 => {:res_target, {:oneof, :node}, {:message, PgQuery.ResTarget}},
        78 => {:multi_assign_ref, {:oneof, :node}, {:message, PgQuery.MultiAssignRef}},
        79 => {:sort_by, {:oneof, :node}, {:message, PgQuery.SortBy}},
        80 => {:window_def, {:oneof, :node}, {:message, PgQuery.WindowDef}},
        81 => {:range_subselect, {:oneof, :node}, {:message, PgQuery.RangeSubselect}},
        82 => {:range_function, {:oneof, :node}, {:message, PgQuery.RangeFunction}},
        83 => {:range_table_func, {:oneof, :node}, {:message, PgQuery.RangeTableFunc}},
        84 => {:range_table_func_col, {:oneof, :node}, {:message, PgQuery.RangeTableFuncCol}},
        85 => {:range_table_sample, {:oneof, :node}, {:message, PgQuery.RangeTableSample}},
        86 => {:column_def, {:oneof, :node}, {:message, PgQuery.ColumnDef}},
        87 => {:table_like_clause, {:oneof, :node}, {:message, PgQuery.TableLikeClause}},
        88 => {:index_elem, {:oneof, :node}, {:message, PgQuery.IndexElem}},
        89 => {:def_elem, {:oneof, :node}, {:message, PgQuery.DefElem}},
        90 => {:locking_clause, {:oneof, :node}, {:message, PgQuery.LockingClause}},
        91 => {:xml_serialize, {:oneof, :node}, {:message, PgQuery.XmlSerialize}},
        92 => {:partition_elem, {:oneof, :node}, {:message, PgQuery.PartitionElem}},
        93 => {:partition_spec, {:oneof, :node}, {:message, PgQuery.PartitionSpec}},
        94 => {:partition_bound_spec, {:oneof, :node}, {:message, PgQuery.PartitionBoundSpec}},
        95 => {:partition_range_datum, {:oneof, :node}, {:message, PgQuery.PartitionRangeDatum}},
        96 => {:single_partition_spec, {:oneof, :node}, {:message, PgQuery.SinglePartitionSpec}},
        97 => {:partition_cmd, {:oneof, :node}, {:message, PgQuery.PartitionCmd}},
        98 => {:range_tbl_entry, {:oneof, :node}, {:message, PgQuery.RangeTblEntry}},
        99 => {:rtepermission_info, {:oneof, :node}, {:message, PgQuery.RTEPermissionInfo}},
        100 => {:range_tbl_function, {:oneof, :node}, {:message, PgQuery.RangeTblFunction}},
        101 => {:table_sample_clause, {:oneof, :node}, {:message, PgQuery.TableSampleClause}},
        102 => {:with_check_option, {:oneof, :node}, {:message, PgQuery.WithCheckOption}},
        103 => {:sort_group_clause, {:oneof, :node}, {:message, PgQuery.SortGroupClause}},
        104 => {:grouping_set, {:oneof, :node}, {:message, PgQuery.GroupingSet}},
        105 => {:window_clause, {:oneof, :node}, {:message, PgQuery.WindowClause}},
        106 => {:row_mark_clause, {:oneof, :node}, {:message, PgQuery.RowMarkClause}},
        107 => {:with_clause, {:oneof, :node}, {:message, PgQuery.WithClause}},
        108 => {:infer_clause, {:oneof, :node}, {:message, PgQuery.InferClause}},
        109 => {:on_conflict_clause, {:oneof, :node}, {:message, PgQuery.OnConflictClause}},
        110 => {:ctesearch_clause, {:oneof, :node}, {:message, PgQuery.CTESearchClause}},
        111 => {:ctecycle_clause, {:oneof, :node}, {:message, PgQuery.CTECycleClause}},
        112 => {:common_table_expr, {:oneof, :node}, {:message, PgQuery.CommonTableExpr}},
        113 => {:merge_when_clause, {:oneof, :node}, {:message, PgQuery.MergeWhenClause}},
        114 => {:trigger_transition, {:oneof, :node}, {:message, PgQuery.TriggerTransition}},
        115 => {:json_output, {:oneof, :node}, {:message, PgQuery.JsonOutput}},
        116 => {:json_argument, {:oneof, :node}, {:message, PgQuery.JsonArgument}},
        117 => {:json_func_expr, {:oneof, :node}, {:message, PgQuery.JsonFuncExpr}},
        118 => {:json_table_path_spec, {:oneof, :node}, {:message, PgQuery.JsonTablePathSpec}},
        119 => {:json_table, {:oneof, :node}, {:message, PgQuery.JsonTable}},
        120 => {:json_table_column, {:oneof, :node}, {:message, PgQuery.JsonTableColumn}},
        121 => {:json_key_value, {:oneof, :node}, {:message, PgQuery.JsonKeyValue}},
        122 => {:json_parse_expr, {:oneof, :node}, {:message, PgQuery.JsonParseExpr}},
        123 => {:json_scalar_expr, {:oneof, :node}, {:message, PgQuery.JsonScalarExpr}},
        124 => {:json_serialize_expr, {:oneof, :node}, {:message, PgQuery.JsonSerializeExpr}},
        125 =>
          {:json_object_constructor, {:oneof, :node}, {:message, PgQuery.JsonObjectConstructor}},
        126 =>
          {:json_array_constructor, {:oneof, :node}, {:message, PgQuery.JsonArrayConstructor}},
        127 =>
          {:json_array_query_constructor, {:oneof, :node},
           {:message, PgQuery.JsonArrayQueryConstructor}},
        128 => {:json_agg_constructor, {:oneof, :node}, {:message, PgQuery.JsonAggConstructor}},
        129 => {:json_object_agg, {:oneof, :node}, {:message, PgQuery.JsonObjectAgg}},
        130 => {:json_array_agg, {:oneof, :node}, {:message, PgQuery.JsonArrayAgg}},
        131 => {:raw_stmt, {:oneof, :node}, {:message, PgQuery.RawStmt}},
        132 => {:insert_stmt, {:oneof, :node}, {:message, PgQuery.InsertStmt}},
        133 => {:delete_stmt, {:oneof, :node}, {:message, PgQuery.DeleteStmt}},
        134 => {:update_stmt, {:oneof, :node}, {:message, PgQuery.UpdateStmt}},
        135 => {:merge_stmt, {:oneof, :node}, {:message, PgQuery.MergeStmt}},
        136 => {:select_stmt, {:oneof, :node}, {:message, PgQuery.SelectStmt}},
        137 => {:set_operation_stmt, {:oneof, :node}, {:message, PgQuery.SetOperationStmt}},
        138 => {:return_stmt, {:oneof, :node}, {:message, PgQuery.ReturnStmt}},
        139 => {:plassign_stmt, {:oneof, :node}, {:message, PgQuery.PLAssignStmt}},
        140 => {:create_schema_stmt, {:oneof, :node}, {:message, PgQuery.CreateSchemaStmt}},
        141 => {:alter_table_stmt, {:oneof, :node}, {:message, PgQuery.AlterTableStmt}},
        142 => {:replica_identity_stmt, {:oneof, :node}, {:message, PgQuery.ReplicaIdentityStmt}},
        143 => {:alter_table_cmd, {:oneof, :node}, {:message, PgQuery.AlterTableCmd}},
        144 => {:alter_collation_stmt, {:oneof, :node}, {:message, PgQuery.AlterCollationStmt}},
        145 => {:alter_domain_stmt, {:oneof, :node}, {:message, PgQuery.AlterDomainStmt}},
        146 => {:grant_stmt, {:oneof, :node}, {:message, PgQuery.GrantStmt}},
        147 => {:object_with_args, {:oneof, :node}, {:message, PgQuery.ObjectWithArgs}},
        148 => {:access_priv, {:oneof, :node}, {:message, PgQuery.AccessPriv}},
        149 => {:grant_role_stmt, {:oneof, :node}, {:message, PgQuery.GrantRoleStmt}},
        150 =>
          {:alter_default_privileges_stmt, {:oneof, :node},
           {:message, PgQuery.AlterDefaultPrivilegesStmt}},
        151 => {:copy_stmt, {:oneof, :node}, {:message, PgQuery.CopyStmt}},
        152 => {:variable_set_stmt, {:oneof, :node}, {:message, PgQuery.VariableSetStmt}},
        153 => {:variable_show_stmt, {:oneof, :node}, {:message, PgQuery.VariableShowStmt}},
        154 => {:create_stmt, {:oneof, :node}, {:message, PgQuery.CreateStmt}},
        155 => {:constraint, {:oneof, :node}, {:message, PgQuery.Constraint}},
        156 =>
          {:create_table_space_stmt, {:oneof, :node}, {:message, PgQuery.CreateTableSpaceStmt}},
        157 => {:drop_table_space_stmt, {:oneof, :node}, {:message, PgQuery.DropTableSpaceStmt}},
        158 =>
        ...
        160 => {:create_extension_stmt, {:oneof, :node}, {:message, PgQuery.CreateExtensionStmt}},
        161 => {:alter_extension_stmt, {:oneof, :node}, {:message, PgQuery.AlterExtensionStmt}},
        162 =>
          {:alter_extension_contents_stmt, {:oneof, :node},
           {:message, PgQuery.AlterExtensionContentsStmt}},
        163 => {:create_fdw_stmt, {:oneof, :node}, {:message, PgQuery.CreateFdwStmt}},
        164 => {:alter_fdw_stmt, {:oneof, :node}, {:message, PgQuery.AlterFdwStmt}},
        165 =>
        ...
        172 => {:create_policy_stmt, {:oneof, :node}, {:message, PgQuery.CreatePolicyStmt}},
        173 => {:alter_policy_stmt, {:oneof, :node}, {:message, PgQuery.AlterPolicyStmt}},
        174 => {:create_am_stmt, {:oneof, :node}, {:message, PgQuery.CreateAmStmt}},
        175 => {:create_trig_stmt, {:oneof, :node}, {:message, PgQuery.CreateTrigStmt}},
        176 =>
          {:create_event_trig_stmt, {:oneof, :node}, {:message, PgQuery.CreateEventTrigStmt}},
        177 => {:alter_event_trig_stmt, {:oneof, :node}, {:message, PgQuery.AlterEventTrigStmt}},
        178 => {:create_plang_stmt, {:oneof, :node}, {:message, PgQuery.CreatePLangStmt}},
        179 => {:create_role_stmt, {:oneof, :node}, {:message, PgQuery.CreateRoleStmt}},
        180 => {:alter_role_stmt, {:oneof, :node}, {:message, PgQuery.AlterRoleStmt}},
        181 => {:alter_role_set_stmt, {:oneof, :node}, {:message, PgQuery.AlterRoleSetStmt}},
        182 => {:drop_role_stmt, {:oneof, :node}, {:message, PgQuery.DropRoleStmt}},
        183 => {:create_seq_stmt, {:oneof, :node}, {:message, PgQuery.CreateSeqStmt}},
        184 => {:alter_seq_stmt, {:oneof, :node}, {:message, PgQuery.AlterSeqStmt}},
        185 => {:define_stmt, {:oneof, :node}, {:message, PgQuery.DefineStmt}},
        186 => {:create_domain_stmt, {:oneof, :node}, {:message, PgQuery.CreateDomainStmt}},
        187 => {:create_op_class_stmt, {:oneof, :node}, {:message, PgQuery.CreateOpClassStmt}},
        188 => {:create_op_class_item, {:oneof, :node}, {:message, PgQuery.CreateOpClassItem}},
        189 => {:create_op_family_stmt, {:oneof, :node}, {:message, PgQuery.CreateOpFamilyStmt}},
        190 => {:alter_op_family_stmt, {:oneof, :node}, {:message, PgQuery.AlterOpFamilyStmt}},
        191 => {:drop_stmt, {:oneof, :node}, {:message, PgQuery.DropStmt}},
        192 => {:truncate_stmt, {:oneof, :node}, {:message, PgQuery.TruncateStmt}},
        193 => {:comment_stmt, {:oneof, :node}, {:message, PgQuery.CommentStmt}},
        194 => {:sec_label_stmt, {:oneof, :node}, {:message, PgQuery.SecLabelStmt}},
        195 => {:declare_cursor_stmt, {:oneof, :node}, {:message, PgQuery.DeclareCursorStmt}},
        196 => {:close_portal_stmt, {:oneof, :node}, {:message, PgQuery.ClosePortalStmt}},
        197 => {:fetch_stmt, {:oneof, :node}, {:message, PgQuery.FetchStmt}},
        198 => {:index_stmt, {:oneof, :node}, {:message, PgQuery.IndexStmt}},
        199 => {:create_stats_stmt, {:oneof, :node}, {:message, PgQuery.CreateStatsStmt}},
        200 => {:stats_elem, {:oneof, :node}, {:message, PgQuery.StatsElem}},
        201 => {:alter_stats_stmt, {:oneof, :node}, {:message, PgQuery.AlterStatsStmt}},
        202 => {:create_function_stmt, {:oneof, :node}, {:message, PgQuery.CreateFunctionStmt}},
        203 => {:function_parameter, {:oneof, :node}, {:message, PgQuery.FunctionParameter}},
        204 => {:alter_function_stmt, {:oneof, :node}, {:message, PgQuery.AlterFunctionStmt}},
        205 => {:do_stmt, {:oneof, :node}, {:message, PgQuery.DoStmt}},
        206 => {:inline_code_block, {:oneof, :node}, {:message, PgQuery.InlineCodeBlock}},
        207 => {:call_stmt, {:oneof, :node}, {:message, PgQuery.CallStmt}},
        208 => {:call_context, {:oneof, :node}, {:message, PgQuery.CallContext}},
        209 => {:rename_stmt, {:oneof, :node}, {:message, PgQuery.RenameStmt}},
        210 =>
        ...
        212 => {:alter_owner_stmt, {:oneof, :node}, {:message, PgQuery.AlterOwnerStmt}},
        213 => {:alter_operator_stmt, {:oneof, :node}, {:message, PgQuery.AlterOperatorStmt}},
        214 => {:alter_type_stmt, {:oneof, :node}, {:message, PgQuery.AlterTypeStmt}},
        215 => {:rule_stmt, {:oneof, :node}, {:message, PgQuery.RuleStmt}},
        216 => {:notify_stmt, {:oneof, :node}, {:message, PgQuery.NotifyStmt}},
        217 => {:listen_stmt, {:oneof, :node}, {:message, PgQuery.ListenStmt}},
        218 => {:unlisten_stmt, {:oneof, :node}, {:message, PgQuery.UnlistenStmt}},
        219 => {:transaction_stmt, {:oneof, :node}, {:message, PgQuery.TransactionStmt}},
        220 => {:composite_type_stmt, {:oneof, :node}, {:message, PgQuery.CompositeTypeStmt}},
        221 => {:create_enum_stmt, {:oneof, :node}, {:message, PgQuery.CreateEnumStmt}},
        222 => {:create_range_stmt, {:oneof, :node}, {:message, PgQuery.CreateRangeStmt}},
        223 => {:alter_enum_stmt, {:oneof, :node}, {:message, PgQuery.AlterEnumStmt}},
        224 => {:view_stmt, {:oneof, :node}, {:message, PgQuery.ViewStmt}},
        225 => {:load_stmt, {:oneof, :node}, {:message, PgQuery.LoadStmt}},
        226 => {:createdb_stmt, {:oneof, :node}, {:message, PgQuery.CreatedbStmt}},
        227 => {:alter_database_stmt, {:oneof, :node}, {:message, PgQuery.AlterDatabaseStmt}},
        228 =>
        ...
        230 => {:dropdb_stmt, {:oneof, :node}, {:message, PgQuery.DropdbStmt}},
        231 => {:alter_system_stmt, {:oneof, :node}, {:message, PgQuery.AlterSystemStmt}},
        232 => {:cluster_stmt, {:oneof, :node}, {:message, PgQuery.ClusterStmt}},
        233 => {:vacuum_stmt, {:oneof, :node}, {:message, PgQuery.VacuumStmt}},
        234 => {:vacuum_relation, {:oneof, :node}, {:message, PgQuery.VacuumRelation}},
        235 => {:explain_stmt, {:oneof, :node}, {:message, PgQuery.ExplainStmt}},
        236 => {:create_table_as_stmt, {:oneof, :node}, {:message, PgQuery.CreateTableAsStmt}},
        237 => {:refresh_mat_view_stmt, {:oneof, :node}, {:message, PgQuery.RefreshMatViewStmt}},
        238 => {:check_point_stmt, {:oneof, :node}, {:message, PgQuery.CheckPointStmt}},
        239 => {:discard_stmt, {:oneof, :node}, {:message, PgQuery.DiscardStmt}},
        240 => {:lock_stmt, {:oneof, :node}, {:message, PgQuery.LockStmt}},
        241 => {:constraints_set_stmt, {:oneof, :node}, {:message, PgQuery.ConstraintsSetStmt}},
        242 => {:reindex_stmt, {:oneof, :node}, {:message, PgQuery.ReindexStmt}},
        243 =>
          {:create_conversion_stmt, {:oneof, :node}, {:message, PgQuery.CreateConversionStmt}},
        244 => {:create_cast_stmt, {:oneof, :node}, {:message, PgQuery.CreateCastStmt}},
        245 => {:create_transform_stmt, {:oneof, :node}, {:message, PgQuery.CreateTransformStmt}},
        246 => {:prepare_stmt, {:oneof, :node}, {:message, PgQuery.PrepareStmt}},
        247 => {:execute_stmt, {:oneof, :node}, {:message, PgQuery.ExecuteStmt}},
        248 => {:deallocate_stmt, {:oneof, :node}, {:message, PgQuery.DeallocateStmt}},
        249 => {:drop_owned_stmt, {:oneof, :node}, {:message, PgQuery.DropOwnedStmt}},
        250 => {:reassign_owned_stmt, {:oneof, :node}, {:message, PgQuery.ReassignOwnedStmt}},
        251 =>
        ...
        253 => {:publication_table, {:oneof, :node}, {:message, PgQuery.PublicationTable}},
        254 => {:publication_obj_spec, {:oneof, :node}, {:message, PgQuery.PublicationObjSpec}},
        255 =>
        ...
        260 => {:integer, {:oneof, :node}, {:message, PgQuery.Integer}},
        261 => {:float, {:oneof, :node}, {:message, PgQuery.Float}},
        262 => {:boolean, {:oneof, :node}, {:message, PgQuery.Boolean}},
        263 => {:string, {:oneof, :node}, {:message, PgQuery.String}},
        264 => {:bit_string, {:oneof, :node}, {:message, PgQuery.BitString}},
        265 => {:list, {:oneof, :node}, {:message, PgQuery.List}},
        266 => {:int_list, {:oneof, :node}, {:message, PgQuery.IntList}},
        267 => {:oid_list, {:oneof, :node}, {:message, PgQuery.OidList}},
        268 => {:a_const, {:oneof, :node}, {:message, PgQuery.A_Const}}
      }
    end
    ...
    def defs_by_name() do
      %{
        a_array_expr: {76, {:oneof, :node}, {:message, PgQuery.A_ArrayExpr}},
        a_const: {268, {:oneof, :node}, {:message, PgQuery.A_Const}},
        a_expr: {68, {:oneof, :node}, {:message, PgQuery.A_Expr}},
        a_indices: {74, {:oneof, :node}, {:message, PgQuery.A_Indices}},
        a_indirection: {75, {:oneof, :node}, {:message, PgQuery.A_Indirection}},
        a_star: {73, {:oneof, :node}, {:message, PgQuery.A_Star}},
        access_priv: {148, {:oneof, :node}, {:message, PgQuery.AccessPriv}},
        aggref: {7, {:oneof, :node}, {:message, PgQuery.Aggref}},
        alias: {1, {:oneof, :node}, {:message, PgQuery.Alias}},
        alter_collation_stmt: {144, {:oneof, :node}, {:message, PgQuery.AlterCollationStmt}},
        alter_database_refresh_coll_stmt:
          {228, {:oneof, :node}, {:message, PgQuery.AlterDatabaseRefreshCollStmt}},
        alter_database_set_stmt: {229, {:oneof, :node}, {:message, PgQuery.AlterDatabaseSetStmt}},
        alter_database_stmt: {227, {:oneof, :node}, {:message, PgQuery.AlterDatabaseStmt}},
        alter_default_privileges_stmt:
          {150, {:oneof, :node}, {:message, PgQuery.AlterDefaultPrivilegesStmt}},
        alter_domain_stmt: {145, {:oneof, :node}, {:message, PgQuery.AlterDomainStmt}},
        alter_enum_stmt: {223, {:oneof, :node}, {:message, PgQuery.AlterEnumStmt}},
        alter_event_trig_stmt: {177, {:oneof, :node}, {:message, PgQuery.AlterEventTrigStmt}},
        alter_extension_contents_stmt:
          {162, {:oneof, :node}, {:message, PgQuery.AlterExtensionContentsStmt}},
        alter_extension_stmt: {161, {:oneof, :node}, {:message, PgQuery.AlterExtensionStmt}},
        alter_fdw_stmt: {164, {:oneof, :node}, {:message, PgQuery.AlterFdwStmt}},
        alter_foreign_server_stmt:
          {166, {:oneof, :node}, {:message, PgQuery.AlterForeignServerStmt}},
        alter_function_stmt: {204, {:oneof, :node}, {:message, PgQuery.AlterFunctionStmt}},
        alter_object_depends_stmt:
          {210, {:oneof, :node}, {:message, PgQuery.AlterObjectDependsStmt}},
        alter_object_schema_stmt:
          {211, {:oneof, :node}, {:message, PgQuery.AlterObjectSchemaStmt}},
        alter_op_family_stmt: {190, {:oneof, :node}, {:message, PgQuery.AlterOpFamilyStmt}},
        alter_operator_stmt: {213, {:oneof, :node}, {:message, PgQuery.AlterOperatorStmt}},
        alter_owner_stmt: {212, {:oneof, :node}, {:message, PgQuery.AlterOwnerStmt}},
        alter_policy_stmt: {173, {:oneof, :node}, {:message, PgQuery.AlterPolicyStmt}},
        alter_publication_stmt: {256, {:oneof, :node}, {:message, PgQuery.AlterPublicationStmt}},
        alter_role_set_stmt: {181, {:oneof, :node}, {:message, PgQuery.AlterRoleSetStmt}},
        alter_role_stmt: {180, {:oneof, :node}, {:message, PgQuery.AlterRoleStmt}},
        alter_seq_stmt: {184, {:oneof, :node}, {:message, PgQuery.AlterSeqStmt}},
        alter_stats_stmt: {201, {:oneof, :node}, {:message, PgQuery.AlterStatsStmt}},
        alter_subscription_stmt:
          {258, {:oneof, :node}, {:message, PgQuery.AlterSubscriptionStmt}},
        alter_system_stmt: {231, {:oneof, :node}, {:message, PgQuery.AlterSystemStmt}},
        alter_table_cmd: {143, {:oneof, :node}, {:message, PgQuery.AlterTableCmd}},
        alter_table_move_all_stmt:
          {159, {:oneof, :node}, {:message, PgQuery.AlterTableMoveAllStmt}},
        alter_table_space_options_stmt:
          {158, {:oneof, :node}, {:message, PgQuery.AlterTableSpaceOptionsStmt}},
        alter_table_stmt: {141, {:oneof, :node}, {:message, PgQuery.AlterTableStmt}},
        alter_tsconfiguration_stmt:
          {252, {:oneof, :node}, {:message, PgQuery.AlterTSConfigurationStmt}},
        alter_tsdictionary_stmt:
          {251, {:oneof, :node}, {:message, PgQuery.AlterTSDictionaryStmt}},
        alter_type_stmt: {214, {:oneof, :node}, {:message, PgQuery.AlterTypeStmt}},
        alter_user_mapping_stmt: {169, {:oneof, :node}, {:message, PgQuery.AlterUserMappingStmt}},
        alternative_sub_plan: {22, {:oneof, :node}, {:message, PgQuery.AlternativeSubPlan}},
        array_coerce_expr: {27, {:oneof, :node}, {:message, PgQuery.ArrayCoerceExpr}},
        array_expr: {33, {:oneof, :node}, {:message, PgQuery.ArrayExpr}},
        bit_string: {264, {:oneof, :node}, {:message, PgQuery.BitString}},
        bool_expr: {19, {:oneof, :node}, {:message, PgQuery.BoolExpr}},
        boolean: {262, {:oneof, :node}, {:message, PgQuery.Boolean}},
        boolean_test: {51, {:oneof, :node}, {:message, PgQuery.BooleanTest}},
        call_context: {208, {:oneof, :node}, {:message, PgQuery.CallContext}},
        call_stmt: {207, {:oneof, :node}, {:message, PgQuery.CallStmt}},
        case_expr: {30, {:oneof, :node}, {:message, PgQuery.CaseExpr}},
        case_test_expr: {32, {:oneof, :node}, {:message, PgQuery.CaseTestExpr}},
        case_when: {31, {:oneof, :node}, {:message, PgQuery.CaseWhen}},
        check_point_stmt: {238, {:oneof, :node}, {:message, PgQuery.CheckPointStmt}},
        close_portal_stmt: {196, {:oneof, :node}, {:message, PgQuery.ClosePortalStmt}},
        cluster_stmt: {232, {:oneof, :node}, {:message, PgQuery.ClusterStmt}},
        coalesce_expr: {36, {:oneof, :node}, {:message, PgQuery.CoalesceExpr}},
        coerce_to_domain: {53, {:oneof, :node}, {:message, PgQuery.CoerceToDomain}},
        coerce_to_domain_value: {54, {:oneof, :node}, {:message, PgQuery.CoerceToDomainValue}},
        coerce_via_io: {26, {:oneof, :node}, {:message, PgQuery.CoerceViaIO}},
        collate_clause: {70, {:oneof, :node}, {:message, PgQuery.CollateClause}},
        collate_expr: {29, {:oneof, :node}, {:message, PgQuery.CollateExpr}},
        column_def: {86, {:oneof, :node}, {:message, PgQuery.ColumnDef}},
        column_ref: {66, {:oneof, :node}, {:message, PgQuery.ColumnRef}},
        comment_stmt: {193, {:oneof, :node}, {:message, PgQuery.CommentStmt}},
        common_table_expr: {112, {:oneof, :node}, {:message, PgQuery.CommonTableExpr}},
        composite_type_stmt: {220, {:oneof, :node}, {:message, PgQuery.CompositeTypeStmt}},
        constraint: {155, {:oneof, :node}, {:message, PgQuery.Constraint}},
        constraints_set_stmt: {241, {:oneof, :node}, {:message, PgQuery.ConstraintsSetStmt}},
        convert_rowtype_expr: {28, {:oneof, :node}, {:message, PgQuery.ConvertRowtypeExpr}},
        copy_stmt: {151, {:oneof, :node}, {:message, PgQuery.CopyStmt}},
        create_am_stmt: {174, {:oneof, :node}, {:message, PgQuery.CreateAmStmt}},
        create_cast_stmt: {244, {:oneof, :node}, {:message, PgQuery.CreateCastStmt}},
        create_conversion_stmt: {243, {:oneof, :node}, {:message, PgQuery.CreateConversionStmt}},
        create_domain_stmt: {186, {:oneof, :node}, {:message, PgQuery.CreateDomainStmt}},
        create_enum_stmt: {221, {:oneof, :node}, {:message, PgQuery.CreateEnumStmt}},
        create_event_trig_stmt: {176, {:oneof, :node}, {:message, PgQuery.CreateEventTrigStmt}},
        create_extension_stmt: {160, {:oneof, :node}, {:message, PgQuery.CreateExtensionStmt}},
        create_fdw_stmt: {163, {:oneof, :node}, {:message, PgQuery.CreateFdwStmt}},
        create_foreign_server_stmt:
          {165, {:oneof, :node}, {:message, PgQuery.CreateForeignServerStmt}},
        create_foreign_table_stmt:
          {167, {:oneof, :node}, {:message, PgQuery.CreateForeignTableStmt}},
        create_function_stmt: {202, {:oneof, :node}, {:message, PgQuery.CreateFunctionStmt}},
        create_op_class_item: {188, {:oneof, :node}, {:message, PgQuery.CreateOpClassItem}},
        create_op_class_stmt: {187, {:oneof, :node}, {:message, PgQuery.CreateOpClassStmt}},
        create_op_family_stmt: {189, {:oneof, :node}, {:message, PgQuery.CreateOpFamilyStmt}},
        create_plang_stmt: {178, {:oneof, :node}, {:message, PgQuery.CreatePLangStmt}},
        create_policy_stmt: {172, {:oneof, :node}, {:message, PgQuery.CreatePolicyStmt}},
        create_publication_stmt:
          {255, {:oneof, :node}, {:message, PgQuery.CreatePublicationStmt}},
        create_range_stmt: {222, {:oneof, :node}, {:message, PgQuery.CreateRangeStmt}},
        create_role_stmt: {179, {:oneof, :node}, {:message, PgQuery.CreateRoleStmt}},
        create_schema_stmt: {140, {:oneof, :node}, {:message, PgQuery.CreateSchemaStmt}},
        create_seq_stmt: {183, {:oneof, :node}, {:message, PgQuery.CreateSeqStmt}},
        create_stats_stmt: {199, {:oneof, :node}, {:message, PgQuery.CreateStatsStmt}},
        create_stmt: {154, {:oneof, :node}, {:message, PgQuery.CreateStmt}},
        create_subscription_stmt:
          {257, {:oneof, :node}, {:message, PgQuery.CreateSubscriptionStmt}},
        create_table_as_stmt: {236, {:oneof, :node}, {:message, PgQuery.CreateTableAsStmt}},
        create_table_space_stmt: {156, {:oneof, :node}, {:message, PgQuery.CreateTableSpaceStmt}},
        create_transform_stmt: {245, {:oneof, :node}, {:message, PgQuery.CreateTransformStmt}},
        create_trig_stmt: {175, {:oneof, :node}, {:message, PgQuery.CreateTrigStmt}},
        create_user_mapping_stmt:
          {168, {:oneof, :node}, {:message, PgQuery.CreateUserMappingStmt}},
        createdb_stmt: {226, {:oneof, :node}, {:message, PgQuery.CreatedbStmt}},
        ctecycle_clause: {111, {:oneof, :node}, {:message, PgQuery.CTECycleClause}},
        ctesearch_clause: {110, {:oneof, :node}, {:message, PgQuery.CTESearchClause}},
        current_of_expr: {56, {:oneof, :node}, {:message, PgQuery.CurrentOfExpr}},
        deallocate_stmt: {248, {:oneof, :node}, {:message, PgQuery.DeallocateStmt}},
        declare_cursor_stmt: {195, {:oneof, :node}, {:message, PgQuery.DeclareCursorStmt}},
        def_elem: {89, {:oneof, :node}, {:message, PgQuery.DefElem}},
        define_stmt: {185, {:oneof, :node}, {:message, PgQuery.DefineStmt}},
        delete_stmt: {133, {:oneof, :node}, {:message, PgQuery.DeleteStmt}},
        discard_stmt: {239, {:oneof, :node}, {:message, PgQuery.DiscardStmt}},
        distinct_expr: {16, {:oneof, :node}, {:message, PgQuery.DistinctExpr}},
        do_stmt: {205, {:oneof, :node}, {:message, PgQuery.DoStmt}},
        drop_owned_stmt: {249, {:oneof, :node}, {:message, PgQuery.DropOwnedStmt}},
        drop_role_stmt: {182, {:oneof, :node}, {:message, PgQuery.DropRoleStmt}},
        drop_stmt: {191, {:oneof, :node}, {:message, PgQuery.DropStmt}},
        drop_subscription_stmt: {259, {:oneof, :node}, {:message, PgQuery.DropSubscriptionStmt}},
        drop_table_space_stmt: {157, {:oneof, :node}, {:message, PgQuery.DropTableSpaceStmt}},
        drop_user_mapping_stmt: {170, {:oneof, :node}, {:message, PgQuery.DropUserMappingStmt}},
        dropdb_stmt: {230, {:oneof, :node}, {:message, PgQuery.DropdbStmt}},
        execute_stmt: {247, {:oneof, :node}, {:message, PgQuery.ExecuteStmt}},
        explain_stmt: {235, {:oneof, :node}, {:message, PgQuery.ExplainStmt}},
        fetch_stmt: {197, {:oneof, :node}, {:message, PgQuery.FetchStmt}},
        field_select: {23, {:oneof, :node}, {:message, PgQuery.FieldSelect}},
        field_store: {24, {:oneof, :node}, {:message, PgQuery.FieldStore}},
        float: {261, {:oneof, :node}, {:message, PgQuery.Float}},
        from_expr: {62, {:oneof, :node}, {:message, PgQuery.FromExpr}},
        func_call: {72, {:oneof, :node}, {:message, PgQuery.FuncCall}},
        func_expr: {13, {:oneof, :node}, {:message, PgQuery.FuncExpr}},
        function_parameter: {203, {:oneof, :node}, {:message, PgQuery.FunctionParameter}},
        grant_role_stmt: {149, {:oneof, :node}, {:message, PgQuery.GrantRoleStmt}},
        grant_stmt: {146, {:oneof, :node}, {:message, PgQuery.GrantStmt}},
        grouping_func: {8, {:oneof, :node}, {:message, PgQuery.GroupingFunc}},
        grouping_set: {104, {:oneof, :node}, {:message, PgQuery.GroupingSet}},
        import_foreign_schema_stmt:
          {171, {:oneof, :node}, {:message, PgQuery.ImportForeignSchemaStmt}},
        index_elem: {88, {:oneof, :node}, {:message, PgQuery.IndexElem}},
        index_stmt: {198, {:oneof, :node}, {:message, PgQuery.IndexStmt}},
        infer_clause: {108, {:oneof, :node}, {:message, PgQuery.InferClause}},
        inference_elem: {58, {:oneof, :node}, {:message, PgQuery.InferenceElem}},
        inline_code_block: {206, {:oneof, :node}, {:message, PgQuery.InlineCodeBlock}},
        insert_stmt: {132, {:oneof, :node}, {:message, PgQuery.InsertStmt}},
        int_list: {266, {:oneof, :node}, {:message, PgQuery.IntList}},
        integer: {260, {:oneof, :node}, {:message, PgQuery.Integer}},
        into_clause: {4, {:oneof, :node}, {:message, PgQuery.IntoClause}},
        join_expr: {61, {:oneof, :node}, {:message, PgQuery.JoinExpr}},
        json_agg_constructor: {128, {:oneof, :node}, {:message, PgQuery.JsonAggConstructor}},
        json_argument: {116, {:oneof, :node}, {:message, PgQuery.JsonArgument}},
        json_array_agg: {130, {:oneof, :node}, {:message, PgQuery.JsonArrayAgg}},
        json_array_constructor: {126, {:oneof, :node}, {:message, PgQuery.JsonArrayConstructor}},
        json_array_query_constructor:
          {127, {:oneof, :node}, {:message, PgQuery.JsonArrayQueryConstructor}},
        json_behavior: {45, {:oneof, :node}, {:message, PgQuery.JsonBehavior}},
        json_constructor_expr: {43, {:oneof, :node}, {:message, PgQuery.JsonConstructorExpr}},
        json_expr: {46, {:oneof, :node}, {:message, PgQuery.JsonExpr}},
        json_format: {40, {:oneof, :node}, {:message, PgQuery.JsonFormat}},
        json_func_expr: {117, {:oneof, :node}, {:message, PgQuery.JsonFuncExpr}},
        json_is_predicate: {44, {:oneof, :node}, {:message, PgQuery.JsonIsPredicate}},
        json_key_value: {121, {:oneof, :node}, {:message, PgQuery.JsonKeyValue}},
        json_object_agg: {129, {:oneof, :node}, {:message, PgQuery.JsonObjectAgg}},
        json_object_constructor:
          {125, {:oneof, :node}, {:message, PgQuery.JsonObjectConstructor}},
        json_output: {115, {:oneof, :node}, {:message, PgQuery.JsonOutput}},
        json_parse_expr: {122, {:oneof, :node}, {:message, PgQuery.JsonParseExpr}},
        json_returning: {41, {:oneof, :node}, {:message, PgQuery.JsonReturning}},
        json_scalar_expr: {123, {:oneof, :node}, {:message, PgQuery.JsonScalarExpr}},
        json_serialize_expr: {124, {:oneof, :node}, {:message, PgQuery.JsonSerializeExpr}},
        json_table: {119, {:oneof, :node}, {:message, PgQuery.JsonTable}},
        json_table_column: {120, {:oneof, :node}, {:message, PgQuery.JsonTableColumn}},
        json_table_path: {47, {:oneof, :node}, {:message, PgQuery.JsonTablePath}},
        json_table_path_scan: {48, {:oneof, :node}, {:message, PgQuery.JsonTablePathScan}},
        json_table_path_spec: {118, {:oneof, :node}, {:message, PgQuery.JsonTablePathSpec}},
        json_table_sibling_join: {49, {:oneof, :node}, {:message, PgQuery.JsonTableSiblingJoin}},
        json_value_expr: {42, {:oneof, :node}, {:message, PgQuery.JsonValueExpr}},
        list: {265, {:oneof, :node}, {:message, PgQuery.List}},
        listen_stmt: {217, {:oneof, :node}, {:message, PgQuery.ListenStmt}},
        load_stmt: {225, {:oneof, :node}, {:message, PgQuery.LoadStmt}},
        lock_stmt: {240, {:oneof, :node}, {:message, PgQuery.LockStmt}},
        locking_clause: {90, {:oneof, :node}, {:message, PgQuery.LockingClause}},
        merge_action: {52, {:oneof, :node}, {:message, PgQuery.MergeAction}},
        merge_stmt: {135, {:oneof, :node}, {:message, PgQuery.MergeStmt}},
        merge_support_func: {11, {:oneof, :node}, {:message, PgQuery.MergeSupportFunc}},
        merge_when_clause: {113, {:oneof, :node}, {:message, PgQuery.MergeWhenClause}},
        min_max_expr: {37, {:oneof, :node}, {:message, PgQuery.MinMaxExpr}},
        multi_assign_ref: {78, {:oneof, :node}, {:message, PgQuery.MultiAssignRef}},
        named_arg_expr: {14, {:oneof, :node}, {:message, PgQuery.NamedArgExpr}},
        next_value_expr: {57, {:oneof, :node}, {:message, PgQuery.NextValueExpr}},
        notify_stmt: {216, {:oneof, :node}, {:message, PgQuery.NotifyStmt}},
        null_if_expr: {17, {:oneof, :node}, {:message, PgQuery.NullIfExpr}},
        null_test: {50, {:oneof, :node}, {:message, PgQuery.NullTest}},
        object_with_args: {147, {:oneof, :node}, {:message, PgQuery.ObjectWithArgs}},
        oid_list: {267, {:oneof, :node}, {:message, PgQuery.OidList}},
        on_conflict_clause: {109, {:oneof, :node}, {:message, PgQuery.OnConflictClause}},
        on_conflict_expr: {63, {:oneof, :node}, {:message, PgQuery.OnConflictExpr}},
        op_expr: {15, {:oneof, :node}, {:message, PgQuery.OpExpr}},
        param: {6, {:oneof, :node}, {:message, PgQuery.Param}},
        param_ref: {67, {:oneof, :node}, {:message, PgQuery.ParamRef}},
        partition_bound_spec: {94, {:oneof, :node}, {:message, PgQuery.PartitionBoundSpec}},
        partition_cmd: {97, {:oneof, :node}, {:message, PgQuery.PartitionCmd}},
        partition_elem: {92, {:oneof, :node}, {:message, PgQuery.PartitionElem}},
        partition_range_datum: {95, {:oneof, :node}, {:message, PgQuery.PartitionRangeDatum}},
        partition_spec: {93, {:oneof, :node}, {:message, PgQuery.PartitionSpec}},
        plassign_stmt: {139, {:oneof, :node}, {:message, PgQuery.PLAssignStmt}},
        prepare_stmt: {246, {:oneof, :node}, {:message, PgQuery.PrepareStmt}},
        publication_obj_spec: {254, {:oneof, :node}, {:message, PgQuery.PublicationObjSpec}},
        publication_table: {253, {:oneof, :node}, {:message, PgQuery.PublicationTable}},
        query: {64, {:oneof, :node}, {:message, PgQuery.Query}},
        range_function: {82, {:oneof, :node}, {:message, PgQuery.RangeFunction}},
        range_subselect: {81, {:oneof, :node}, {:message, PgQuery.RangeSubselect}},
        range_table_func: {83, {:oneof, :node}, {:message, PgQuery.RangeTableFunc}},
        range_table_func_col: {84, {:oneof, :node}, {:message, PgQuery.RangeTableFuncCol}},
        range_table_sample: {85, {:oneof, :node}, {:message, PgQuery.RangeTableSample}},
        range_tbl_entry: {98, {:oneof, :node}, {:message, PgQuery.RangeTblEntry}},
        range_tbl_function: {100, {:oneof, :node}, {:message, PgQuery.RangeTblFunction}},
        range_tbl_ref: {60, {:oneof, :node}, {:message, PgQuery.RangeTblRef}},
        range_var: {2, {:oneof, :node}, {:message, PgQuery.RangeVar}},
        raw_stmt: {131, {:oneof, :node}, {:message, PgQuery.RawStmt}},
        reassign_owned_stmt: {250, {:oneof, :node}, {:message, PgQuery.ReassignOwnedStmt}},
        refresh_mat_view_stmt: {237, {:oneof, :node}, {:message, PgQuery.RefreshMatViewStmt}},
        reindex_stmt: {242, {:oneof, :node}, {:message, PgQuery.ReindexStmt}},
        relabel_type: {25, {:oneof, :node}, {:message, PgQuery.RelabelType}},
        rename_stmt: {209, {:oneof, :node}, {:message, PgQuery.RenameStmt}},
        replica_identity_stmt: {142, {:oneof, :node}, {:message, PgQuery.ReplicaIdentityStmt}},
        res_target: {77, {:oneof, :node}, {:message, PgQuery.ResTarget}},
        return_stmt: {138, {:oneof, :node}, {:message, PgQuery.ReturnStmt}},
        role_spec: {71, {:oneof, :node}, {:message, PgQuery.RoleSpec}},
        row_compare_expr: {35, {:oneof, :node}, {:message, PgQuery.RowCompareExpr}},
        row_expr: {34, {:oneof, :node}, {:message, PgQuery.RowExpr}},
        row_mark_clause: {106, {:oneof, :node}, {:message, PgQuery.RowMarkClause}},
        rtepermission_info: {99, {:oneof, :node}, {:message, PgQuery.RTEPermissionInfo}},
        rule_stmt: {215, {:oneof, :node}, {:message, PgQuery.RuleStmt}},
        scalar_array_op_expr: {18, {:oneof, :node}, {:message, PgQuery.ScalarArrayOpExpr}},
        sec_label_stmt: {194, {:oneof, :node}, {:message, PgQuery.SecLabelStmt}},
        select_stmt: {136, {:oneof, :node}, {:message, PgQuery.SelectStmt}},
        set_operation_stmt: {137, {:oneof, :node}, {:message, PgQuery.SetOperationStmt}},
        set_to_default: {55, {:oneof, :node}, {:message, PgQuery.SetToDefault}},
        single_partition_spec: {96, {:oneof, :node}, {:message, PgQuery.SinglePartitionSpec}},
        sort_by: {79, {:oneof, :node}, {:message, PgQuery.SortBy}},
        sort_group_clause: {103, {:oneof, :node}, {:message, PgQuery.SortGroupClause}},
        sqlvalue_function: {38, {:oneof, :node}, {:message, PgQuery.SQLValueFunction}},
        stats_elem: {200, {:oneof, :node}, {:message, PgQuery.StatsElem}},
        string: {263, {:oneof, :node}, {:message, PgQuery.String}},
        sub_link: {20, {:oneof, :node}, {:message, PgQuery.SubLink}},
        sub_plan: {21, {:oneof, :node}, {:message, PgQuery.SubPlan}},
        subscripting_ref: {12, {:oneof, :node}, {:message, PgQuery.SubscriptingRef}},
        table_func: {3, {:oneof, :node}, {:message, PgQuery.TableFunc}},
        table_like_clause: {87, {:oneof, :node}, {:message, PgQuery.TableLikeClause}},
        table_sample_clause: {101, {:oneof, :node}, {:message, PgQuery.TableSampleClause}},
        target_entry: {59, {:oneof, :node}, {:message, PgQuery.TargetEntry}},
        transaction_stmt: {219, {:oneof, :node}, {:message, PgQuery.TransactionStmt}},
        trigger_transition: {114, {:oneof, :node}, {:message, PgQuery.TriggerTransition}},
        truncate_stmt: {192, {:oneof, :node}, {:message, PgQuery.TruncateStmt}},
        type_cast: {69, {:oneof, :node}, {:message, PgQuery.TypeCast}},
        type_name: {65, {:oneof, :node}, {:message, PgQuery.TypeName}},
        unlisten_stmt: {218, {:oneof, :node}, {:message, PgQuery.UnlistenStmt}},
        update_stmt: {134, {:oneof, :node}, {:message, PgQuery.UpdateStmt}},
        vacuum_relation: {234, {:oneof, :node}, {:message, PgQuery.VacuumRelation}},
        vacuum_stmt: {233, {:oneof, :node}, {:message, PgQuery.VacuumStmt}},
        var: {5, {:oneof, :node}, {:message, PgQuery.Var}},
        variable_set_stmt: {152, {:oneof, :node}, {:message, PgQuery.VariableSetStmt}},
        variable_show_stmt: {153, {:oneof, :node}, {:message, PgQuery.VariableShowStmt}},
        view_stmt: {224, {:oneof, :node}, {:message, PgQuery.ViewStmt}},
        window_clause: {105, {:oneof, :node}, {:message, PgQuery.WindowClause}},
        window_def: {80, {:oneof, :node}, {:message, PgQuery.WindowDef}},
        window_func: {9, {:oneof, :node}, {:message, PgQuery.WindowFunc}},
        window_func_run_condition:
          {10, {:oneof, :node}, {:message, PgQuery.WindowFuncRunCondition}},
        with_check_option: {102, {:oneof, :node}, {:message, PgQuery.WithCheckOption}},
        with_clause: {107, {:oneof, :node}, {:message, PgQuery.WithClause}},
        xml_expr: {39, {:oneof, :node}, {:message, PgQuery.XmlExpr}},
        xml_serialize: {91, {:oneof, :node}, {:message, PgQuery.XmlSerialize}}
      }
    end
  )
  ...
  (
    ...
    def fields_defs() do
      [
        ...
        %{
          __struct__: Protox.Field,
          json_name: "windowFuncRunCondition",
          kind: {:oneof, :node},
          label: :optional,
        ...
        %{
          __struct__: Protox.Field,
          json_name: "jsonTableSiblingJoin",
          kind: {:oneof, :node},
          label: :optional,
        ...
        %{
          __struct__: Protox.Field,
          json_name: "jsonObjectConstructor",
          kind: {:oneof, :node},
          label: :optional,
        ...
        %{
          __struct__: Protox.Field,
          json_name: "jsonArrayConstructor",
          kind: {:oneof, :node},
          label: :optional,
        ...
        %{
          __struct__: Protox.Field,
          json_name: "jsonArrayQueryConstructor",
          kind: {:oneof, :node},
          label: :optional,
    ...
    [
      ...
      (
        def field_def(:window_func_run_condition) do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "windowFuncRunCondition",
        ...
        def field_def("windowFuncRunCondition") do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "windowFuncRunCondition",
      ...
      (
        def field_def(:merge_support_func) do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "mergeSupportFunc",
        ...
        def field_def("mergeSupportFunc") do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "mergeSupportFunc",
      ...
      (
        def field_def(:json_returning) do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "jsonReturning",
        ...
        def field_def("jsonReturning") do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "jsonReturning",
      ...
      (
        def field_def(:json_value_expr) do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "jsonValueExpr",
        ...
        def field_def("jsonValueExpr") do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "jsonValueExpr",
      ...
      (
        def field_def(:json_constructor_expr) do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "jsonConstructorExpr",
        ...
        def field_def("jsonConstructorExpr") do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "jsonConstructorExpr",
      ...
      (
        def field_def(:json_is_predicate) do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "jsonIsPredicate",
        ...
        def field_def("jsonIsPredicate") do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "jsonIsPredicate",
      ...
      (
        def field_def(:json_behavior) do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "jsonBehavior",
      ...
      (
        def field_def(:json_table_path) do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "jsonTablePath",
        ...
        def field_def("jsonTablePath") do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "jsonTablePath",
      ...
      (
        def field_def(:json_table_path_scan) do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "jsonTablePathScan",
        ...
        def field_def("jsonTablePathScan") do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "jsonTablePathScan",
      ...
      (
        def field_def(:json_table_sibling_join) do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "jsonTableSiblingJoin",
        ...
        def field_def("jsonTableSiblingJoin") do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "jsonTableSiblingJoin",
      ...
      (
        def field_def(:single_partition_spec) do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "singlePartitionSpec",
        ...
        def field_def("singlePartitionSpec") do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "singlePartitionSpec",
      ...
      (
        def field_def(:rtepermission_info) do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "rtepermissionInfo",
        ...
        def field_def("rtepermissionInfo") do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "rtepermissionInfo",
      ...
      (
        def field_def(:json_argument) do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "jsonArgument",
      ...
      (
        def field_def(:json_func_expr) do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "jsonFuncExpr",
      ...
      (
        def field_def(:json_table_path_spec) do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "jsonTablePathSpec",
        ...
        def field_def("jsonTablePathSpec") do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "jsonTablePathSpec",
      ...
      (
        def field_def(:json_table_column) do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "jsonTableColumn",
        ...
        def field_def("jsonTableColumn") do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "jsonTableColumn",
      ...
      (
        def field_def(:json_key_value) do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "jsonKeyValue",
      ...
      (
        def field_def(:json_parse_expr) do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "jsonParseExpr",
        ...
        def field_def("jsonParseExpr") do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "jsonParseExpr",
      ...
      (
        def field_def(:json_scalar_expr) do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "jsonScalarExpr",
        ...
        def field_def("jsonScalarExpr") do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "jsonScalarExpr",
      ...
      (
        def field_def(:json_serialize_expr) do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "jsonSerializeExpr",
        ...
        def field_def("jsonSerializeExpr") do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "jsonSerializeExpr",
      ...
      (
        def field_def(:json_object_constructor) do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "jsonObjectConstructor",
        ...
        def field_def("jsonObjectConstructor") do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "jsonObjectConstructor",
      ...
      (
        def field_def(:json_array_constructor) do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "jsonArrayConstructor",
        ...
        def field_def("jsonArrayConstructor") do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "jsonArrayConstructor",
      ...
      (
        def field_def(:json_array_query_constructor) do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "jsonArrayQueryConstructor",
        ...
        def field_def("jsonArrayQueryConstructor") do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "jsonArrayQueryConstructor",
      ...
      (
        def field_def(:json_agg_constructor) do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "jsonAggConstructor",
        ...
        def field_def("jsonAggConstructor") do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "jsonAggConstructor",
      ...
      (
        def field_def(:json_object_agg) do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "jsonObjectAgg",
        ...
        def field_def("jsonObjectAgg") do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "jsonObjectAgg",
      ...
      (
        def field_def(:json_array_agg) do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "jsonArrayAgg",
