...
defmodule PgQuery.DropSubscriptionStmt do
  @moduledoc false
  defstruct subname: "", missing_ok: false, behavior: :DROP_BEHAVIOR_UNDEFINED
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_subname(msg) |> encode_missing_ok(msg) |> encode_behavior(msg)
      end
    )
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(PgQuery.DropSubscriptionStmt))
        end
      )
    )
