...
defmodule PgQuery.DropOwnedStmt do
  @moduledoc false
  defstruct roles: [], behavior: :DROP_BEHAVIOR_UNDEFINED
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_roles(msg) |> encode_behavior(msg)
      end
    )
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(PgQuery.DropOwnedStmt))
        end
      )
    )
  ...
  (
    ...
    def defs() do
      %{
        ...
        2 => {:behavior, {:scalar, :DROP_BEHAVIOR_UNDEFINED}, {:enum, PgQuery.DropBehavior}}
      }
    end
    ...
    def defs_by_name() do
      %{
        behavior: {2, {:scalar, :DROP_BEHAVIOR_UNDEFINED}, {:enum, PgQuery.DropBehavior}},
