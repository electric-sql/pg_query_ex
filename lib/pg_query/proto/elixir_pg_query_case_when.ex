...
defmodule PgQuery.CaseWhen do
  @moduledoc false
  defstruct xpr: nil, expr: nil, result: nil, location: 0
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_xpr(msg) |> encode_expr(msg) |> encode_result(msg) |> encode_location(msg)
      end
    )
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(PgQuery.CaseWhen))
        end
      )
    )
        ...
        {field, rest} =
          case Protox.Decode.parse_key(bytes) do
            ...
            {3, _, bytes} ->
              ...
              {[result: Protox.MergeMessage.merge(msg.result, PgQuery.Node.decode!(delimited))],
               rest}
  ...
  (
    ...
    def defs() do
      %{
        ...
        3 => {:result, {:scalar, nil}, {:message, PgQuery.Node}},
    ...
    def defs_by_name() do
      %{
        ...
        result: {3, {:scalar, nil}, {:message, PgQuery.Node}},
