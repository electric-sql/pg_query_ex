...
defmodule PgQuery.ExecuteStmt do
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_name(msg) |> encode_params(msg)
      end
    )
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(PgQuery.ExecuteStmt))
        end
      )
    )
  ...
  (
    ...
    def defs() do
      %{1 => {:name, {:scalar, ""}, :string}, 2 => {:params, :unpacked, {:message, PgQuery.Node}}}
    end
    ...
    def defs_by_name() do
      %{name: {1, {:scalar, ""}, :string}, params: {2, :unpacked, {:message, PgQuery.Node}}}
    end
  )
